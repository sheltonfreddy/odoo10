...
class Sabre(object):
    ...
    APIS = {
        ...
        'v3.shop.flights': ('POST', '/v3.1.0/shop/flights', 'Bargain Finder Max'),
    }
    
    def __init__(self, client_id, client_secret, server='https://api-crt.cert.havail.sabre.com'):
    ...
    def call_method(self, method, *args, **kwargs):
        ...
        #print args,"AAAAAAAAAAAA",kwargs
        if kwargs['data'].get('json', False):
        ...
        #req = urllib2.Request('http://example.com/api/posts/create')
            url = 'https://api-crt.cert.havail.sabre.com/v3.0.0/shop/flights?mode=live&limit=1&view=BFM_ITIN_BASE_TAX_TOTAL_PRICE'
            #print "XXXXXXXXXXXXXXXXXXXX"
            #response = requests.post(url, data=kwargs['data'], headers=kwargs['headers'])
            ...
            with warnings.catch_warnings():
                ...
                #print "-"*30
                #response = requests.post(url, data=kwargs['data']['data'], headers=kwargs['headers'])
                response = requests.post(url, headers=headers, data=json.dumps(kwargs['data']['data']))
                #print "<"*30
                #print response,"RRRRRRRRRRRRRRR"
                #print ">"*30
                return response
            ...
            #print kwargs,"kkkkkkkkkkkkkkkk"
            #print method,"mmmmmmmmmmmmmmmm"
            #print args,"aaaaaaaaaaaaaaa"
        
#             print method,"mmmmmmmmmmmmmmmmm"
#             print args,"aaaaaaaaaaaaaaaaaaa"
#             print kwargs,"kkkkkkkkwwwwwwwww"
#             return getattr(requests, method)(*args, **kwargs)
